package com.subscribe.demo.handler;

import static com.subscribe.demo.concurrency.ThreadRenamer.renameWorkerThread;
...
import com.subscribe.demo.PojaApplication;
import com.subscribe.demo.PojaGenerated;
import com.subscribe.demo.endpoint.EndpointConf;
import com.subscribe.demo.endpoint.event.EventConf;
import com.subscribe.demo.endpoint.event.consumer.EventConsumer;
import com.subscribe.demo.endpoint.event.consumer.model.ConsumableEvent;
import com.subscribe.demo.endpoint.event.consumer.model.ConsumableEventTyper;
